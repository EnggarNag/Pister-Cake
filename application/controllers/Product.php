...
class Product extends CI_Controller
{
	...
	public function add()
	{
		$this->form_validation->set_rules('name', 'Cake name', 'required', [
		...
		if ($this->form_validation->run() == false) {
			...
			$this->session->set_flashdata('success', 'Cake succesfully added.');
		...
		if ($this->form_validation->run() == false) {
			...
			if (!empty($_FILES['image']['name'])) {
				...
				if ($upload) {
					...
					if (file_exists('images/cake/' . $productImage['image']) && $productImage['image']) {
						unlink('images/cake/' . $productImage['image']);
					}
			...
			$this->session->set_flashdata('success', 'Cake succesfully updated.');
	...
	public function delete($id)
	{
		...
		unlink('images/cake/' . $produk['image']);
		$this->product->deleteProduct($id);
		$this->session->set_flashdata('success', 'Cake succesfully deleted.');
